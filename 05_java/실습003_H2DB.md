...
![build.gradle](../.gitbook/assets/build-gradle.png)
...
![localhost 접속 화면](../.gitbook/assets/run.png) ![h2-console 접속 화면](../.gitbook/assets/h2-console.png)
...
![h2-console](../.gitbook/assets/h2-console.png)

위와 같이 h2-console에 접속이 되었다면 application.yml 파일에 설정한 것과 동일한지 체크한 후 connect 버튼을 클릭하여 접속합니다.
...
![h2-console-after-connect](../.gitbook/assets/h2-console-after-connect.png)
