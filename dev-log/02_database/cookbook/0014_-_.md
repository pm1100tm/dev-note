...
INSERT INTO emp_bonus (id, received, type, empno) VALUES
...
위와 같이 `emp` 테이블과 1:N 관계인 `emp_bonus` 테이블을 생성하고 데이터를 추가합니다.

그 후 모든 사원과 부서 위치, 보너스 날짜를 반환하는 쿼리를 아래와 같이 만들 수
