...
GCP CLI, Compute Engine, Pub/Sub, Cloud Logging, 디스크 운영 실습을 정리한다. 명령 실행 전에는 활성 프로젝트·리전·계정·IAM 권한을 확인하고, 실습용 리소스는 비용이 발생하지 않도록 정리한다.
...
* [Cloud Logging Log Writer 오류](gcp_log_writer_-_100_percent.md)
* [GCE에 SSD 디스크 마운트](gcp_mount_ssd_disk_to_gce.md)
* [GCE 부팅 디스크 용량 늘리기](_-_.md)
