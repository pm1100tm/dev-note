...
AWS EC2(Elastic Compute), 나 GCP 의 GCE(Google Compute Engine) 의 용량이 모자라는 경험이 있었습니다. 용량이 모자랄 때 따로 볼륨을 만들고(\*AWS 기준 EBS 또는 EFS), 해당 디스크를 볼륨 마운트하는 방법도 있지만, Boot Disk 의 저장 공간을 변경해야 할 경우도 있습니다.
...
![gcp\_boot\_disk\_increase](../../.gitbook/assets/gcp_boot_disk_increase_1.png)

### 정보를 확인한 후 상단의 Edit 버튼 클릭

![gcp\_boot\_disk\_increase](../../.gitbook/assets/gcp_boot_disk_increase_2.png)

### Properties에서 Size를 변경하고 하단 저장 버튼 클릭

![gcp\_boot\_disk\_increase](../../.gitbook/assets/gcp_boot_disk_increase_3.png)
