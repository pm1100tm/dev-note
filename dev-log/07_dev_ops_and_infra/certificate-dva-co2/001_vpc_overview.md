...
* 리전(Region) 단위 리소스이며, 네트워크 대역(CIDR), Subnet, Routing, 보안 정책 등을 직접 정의할 수 있습니다.
...
> _**➡️ AWS에서 리소스를 “어디에 배치할 것인지”의 기준이 되는 공간**_
...
> _**VPC의 네트워크 트래픽이 “어디로 갈지”를 결정하는 네트워크 규칙표**_
...
![vpc diragram](../../.gitbook/assets/vpc_001_diagram.png)
