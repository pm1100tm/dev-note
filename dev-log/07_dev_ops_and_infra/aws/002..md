...
![admin 유저 생성하기](<../../.gitbook/assets/3 (3).png>) ![admin 유저 생성하기](<../../.gitbook/assets/4 (3).png>)

* 생성하게 되면 12자리의 고유한 번호를 볼 수 있는데 복붙하여 보관하도록 하자.

![admin 유저 생성하기](<../../.gitbook/assets/5 (3).png>)

### 4. 생성한 유저로 다시 로그인하기

![admin 유저 생성하기](<../../.gitbook/assets/6 (3).png>) ![admin 유저 생성하기](<../../.gitbook/assets/7 (3).png>)
...
![vpc 생성](<../../.gitbook/assets/2 (4).png>) ![vpc 생성](<../../.gitbook/assets/3 (4).png>) ![vpc 생성](<../../.gitbook/assets/4 (4).png>)

* 방금 생성한 VPC의 별칭을 VPC-lab 으로 변경(알아보기 쉽도록..!)

![vpc 생성](<../../.gitbook/assets/5 (4).png>)

* VPC를 만들 때 생성된 subnet 의 이름도 public subnet A 로 변경

![vpc 생성](<../../.gitbook/assets/6 (4).png>)

현재까지 아키텍쳐 구성도

![vpc 생성](<../../.gitbook/assets/7 (4).png>)
...
![subnet](<../../.gitbook/assets/9 (2).png>)

### 위에서 생성한 VPC 선택

![subnet](<../../.gitbook/assets/10 (1).png>)

### Subnet Settings 선택

![subnet](<../../.gitbook/assets/11 (2).png>)

### 생성한 Subnet 확인

![subnet](<../../.gitbook/assets/12 (2).png>)
...
![subnet](<../../.gitbook/assets/13 (2).png>)
...
public subnet C 클릭 ![subnet](<../../.gitbook/assets/14 (2).png>)

라우팅 테이블 정보가 없는 것 확인 ![subnet](<../../.gitbook/assets/15 (2).png>)

Edit route table association 클릭 ![subnet](<../../.gitbook/assets/16 (2).png>)

Route table Id 를 기본 것이 아닌, 생성한 VPC의 라우팅 테이블로 설정하고 저장 ![subnet](<../../.gitbook/assets/17 (2).png>)

Destination 에 igw(Internet Gateway) 정보가 보인다면 성공이다. 이 정보는 public subnet A 와 동일하다. ![subnet](<../../.gitbook/assets/18 (2).png>) ![subnet](<../../.gitbook/assets/19 (2).png>)

현재까지 아키텍쳐 구성도

![subnet](<../../.gitbook/assets/20 (2).png>)
...
왼쪽의 탭의 Security 에서 Security Group 선택 후 Create Security Group 버튼 클릭 ![security-group](<../../.gitbook/assets/21 (2).png>)

Security Group 명, 설명, VPC 설정

VPC는 위에서 생성한 VPC를 선택하여, 해당 VPC에 대한 보안그룹을 만들어준다.

![security-group](<../../.gitbook/assets/22 (1).png>)
...
![security-group](<../../.gitbook/assets/23 (1).png>)
