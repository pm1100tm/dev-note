...
![개발 서버 보안그룹](<../.gitbook/assets/sg1 (1).png>) ![RDS 보안그룹](<../.gitbook/assets/sg2 (1).png>)
...
네임드 볼륨 jenkins\_home 를 생성하여 관리합니다.
...
* 특정 경로(./jenkins\_home)에 의존하지 않고, 어떤 서버/환경에서도 동일하게 동작합니다.
...
* 브라우저에서 http://\<JENKINS\_EC2\_PUBLIC\_IP>:8080 접속 →
* Unlock Jenkins (로그에서 비밀번호 확인)
* 관리자 계정 생성
* 플러그인 설치
  * 위의 jenkins\_plugin.txt 를 사용하지 않고, 직접 설치하는 경우
...
_**위의, 2️⃣ Jenkins 서버에 기본 환경 설치 (EC2 #1) 참조**_
...
* 개발 서버의 \~/.ssh/authrized\_keys 에 추가합니다.
...
![Jenkins 서버](<../.gitbook/assets/ssh1 (1).png>)

개발 서버:

![개발 서버](<../.gitbook/assets/ssh2 (1).png>)
...
![Jenkinsfile-dev](<../.gitbook/assets/jenkinsfile-dev (1).png>)
...
* 상단 프로필 -> Credentials 클릭 ![jenkins-credentials](<../.gitbook/assets/jenkins-credential1 (1).png>)
* Stores from partent 의 (global) 클릭 ![jenkins-credentials](<../.gitbook/assets/jenkins-credential2 (1).png>)
* Add Credentials 클릭 ![jenkins-credentials](<../.gitbook/assets/jenkins-credential3 (1).png>)
* Username with password 로 설정
  ...
  * ![jenkins-credentials](<../.gitbook/assets/jenkins-credential4 (1).png>)
...
![jenkins credential](<../.gitbook/assets/jenkins-credential5 (1).png>)

## 8️⃣ GitHub → Jenkins Webhook 연결

* GitHub repo → Settings → Webhooks
  * Payload URL: http://\<JENKINS\_EC2\_PUBLIC\_IP>:8080/github-webhook/
  * Content type: application/json

![github webhook](<../.gitbook/assets/github-webhook (1).png>)

## 9️⃣ Jenkins pipeline 설정

![pipeline](<../.gitbook/assets/jenkins-pipeline1 (1).png>) ![pipeline](<../.gitbook/assets/jenkins-pipeline2 (1).png>) ![pipeline](<../.gitbook/assets/jenkins-pipeline3 (1).png>) ![pipeline](<../.gitbook/assets/jenkins-pipeline4 (1).png>) ![pipeline](<../.gitbook/assets/jenkins-pipeline5 (1).png>) ![pipeline](<../.gitbook/assets/jenkins-pipeline6 (1).png>) ![pipeline](<../.gitbook/assets/jenkins-pipeline7 (1).png>) ![pipeline](<../.gitbook/assets/jenkins-pipeline8 (1).png>) ![pipeline](<../.gitbook/assets/jenkins-pipeline9 (1).png>)
