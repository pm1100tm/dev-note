...
- "\*" → 모든 리소스에 대해 권한 허용
- 예시:
  - 특정 EC2 인스턴스에만 허용하려면 "arn:aws:ec2:ap-northeast-2:12345678\*\*\*\*:instance/i-0abcd1234efgh5678"
    ...
    "Users": [
        {
            ...
            "UserName": "a****",
            "UserId": "A************************8",
            "Arn": "arn:aws:iam::99238242****:user/admin",
        ...
        },
        {
            ...
            "UserName": "d****",
            "UserId": "A************************8",
            "Arn": "arn:aws:iam::99238242****:user/dev-swd",
